...
ALTER PROCEDURE p_REMOVER_ITEM(@NOME_CLIENTE VARCHAR(60), @VENDAID INT, @PRODID INT, @QTDREMOVER INT, @QTD_TOTAL_ITEM INT, @VALOR_TOTAL_VENDA DECIMAL(10,2), @VALOR_TOTAL_ITEM DECIMAL(10,2), @ITEM_VENDA_ID INT)
AS
...
exec p_REMOVER_ITEM @NOME_CLIENTE='CLIENTE-1', @VENDAID = 1, @PRODID =  1, @QTDREMOVER =1,  @QTD_TOTAL_ITEM = 1, @VALOR_TOTAL_VENDA = 20.00, @VALOR_TOTAL_ITEM = 10.00
