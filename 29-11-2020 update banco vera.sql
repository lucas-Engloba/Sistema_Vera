...
BEGIN
UPDATE TBL_ITEM_VENDA SET ITEM_QTD -= @QTDREMOVER, ITEM_VALOR -= @VALORREMOVER WHERE PROD_ID = @PRODID AND VEN_ID = @VENDAID 
...
exec p_REMOVER_ITEM @NOME_CLIENTE='CLIENTE-1', @VENDAID = 3, @PRODID =  3, @QTDREMOVER =1,  @QTD_TOTAL_ITEM = 1, @VALOR_TOTAL_VENDA = 14.00, @VALOR_TOTAL_ITEM = 4.00
